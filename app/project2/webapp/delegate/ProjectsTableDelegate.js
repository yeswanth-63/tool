    ...
    GenericTableDelegate.fetchProperties = function (oTable) {
        ...
        return oMetaModel.requestObject(`/${sCollectionPath}/$Type`)
            ...
            .catch(function (oError) {
                ...
                // Fallback properties for Projects
                const mFallbackProperties = {
                    "Projects": [
                        { name: "sapPId", path: "sapPId", label: "SAP Project ID", dataType: "Edm.Int32", sortable: true, filterable: true, groupable: true },
                        { name: "sfdcPId", path: "sfdcPId", label: "SFDC Project ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        ...
                        { name: "pmo", path: "pmo", label: "PMO", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "oppId", path: "oppId", label: "Opportunity ID", dataType: "Edm.Int32", sortable: true, filterable: true, groupable: true }
                    ]
                };
