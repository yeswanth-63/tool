    ...
    GenericTableDelegate.fetchProperties = function (oTable) {
        ...
        return oMetaModel.requestObject(`/${sCollectionPath}/$Type`)
            ...
            .catch(function (oError) {
                ...
                // Fallback properties for Employees
                const mFallbackProperties = {
                    "Employees": [
                        { name: "ohrId", path: "ohrId", label: "OHR ID", dataType: "Edm.Int32", sortable: true, filterable: true, groupable: true },
                        ...
                        { name: "gender", path: "gender", label: "Gender", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "dob", path: "dob", label: "Date of Birth", dataType: "Edm.Date", sortable: true, filterable: true, groupable: true },
                        ...
                        { name: "experience", path: "experience", label: "Experience", dataType: "Edm.Int32", sortable: true, filterable: true, groupable: true },
                        { name: "poc", path: "poc", label: "POC", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "sapidstatusId", path: "sapidstatusId", label: "SAP ID Status", dataType: "Edm.Int32", sortable: true, filterable: true, groupable: true }
                    ]
                };
